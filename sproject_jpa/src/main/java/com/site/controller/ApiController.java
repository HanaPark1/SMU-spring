...
@Controller
public class ApiController { //api 페이지 열기
	@GetMapping("/api/list")
	...
	public String api(
		...
		//api 호출 - 가쟈오기 (공공데이터포털에서 가져온 소스)
		String service_key = "%2FkR9HCv6YxY%2BIeqWi9UvUKEJOq%2BLYqmmG13nKO1%2BxTsnOnFq0Kfd4%2BwlGPwquoCQRfOXb14SqKhKucCRsv%2BeOw%3D%3D";
		...
		model.addAttribute("apiList", sb.toString());
