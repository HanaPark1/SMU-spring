		...
		<div id="outbox">		
			<div id="left">
				...
				<ul>	
					...
					<li><a href="#" id="leftNavi3">FAQ</a></li>
				...
				<div id="mypage">
					...
					<form action="/customer/write" method="post" name="writeFrm">
							...
							<table summary="분류, 구매여부, 작은이미지, 평가, 제목, 상세 내용 순으로 포토 구매후기를 작성 하실수 있습니다." class="checkTable" border="1" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" class="wlong" name="name" value="${session_name }" requied/>
						...
						<div class="btnArea">
							<div class="bCenter">
								<ul>																
									<li><a href="#" class="nbtnbig" onclick="location.href='/customer/list'">취소</a></li>
									<li><a href="#" class="sbtnMini" onclick="writeBtn()">확인</a></li>
								</ul>
							</div>
						</div>
						<!-- //Btn Area -->
