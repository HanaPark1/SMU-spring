			...
			<form action="/member/insert02" name="agree" method="post" >
				...
				<fieldset class="fieldset_class">
					<dl id="join_name_dl">
						<dt>
							<div></div>
							<label for="name" value="${member.name }">이름</label>
						</dt>
						<dd>
							<input type="text" id="name" name="name" value="${member.id }" required/>
						</dd>
					</dl>
					<dl id="join_id_dl">
						<dt>
					...
					<dl id="join_pw1_dl">
						...
						<dd>
							<input type="password" id="pw1" name="pw" minlength="3" value="${member.pw }" required />
