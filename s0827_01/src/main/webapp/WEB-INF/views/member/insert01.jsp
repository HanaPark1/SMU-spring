...
<html>
	...
	<body>
		...
		<section>
			<form name="agree" method="get" action="/member/insert02/">
				...
				<div class="agreeRadio">
					<input type="radio" class="agree_all" name="agree_all" id="t_agree" value="agree" />
					<label for="t_agree">개인정보 취급위탁에 동의합니다.</label>
					<input type="radio" name="t_agree" id="t_disagree" value="disagree" />
					<label for="t_disagree®r">동의하지 않습니다.</label>
				</div>
				<div class="strong_div">
				...
				<script>
					function insertBtn() {
						...
						if(agree_num < 3) {
							alert("모두 동의를 하셔야 다음 단계로 진행 가능합니다.");
							return;
						} else {
							alert("다음으로 진행합니다.");
							agree.submit()
